...
static esp_mqtt_client_handle_t *client_g = NULL;
...
static void mqtt5_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        int max_i = 100;
        char *str = (char*)malloc(max_i * 4 * sizeof(char) + 1);
        *str = '\0';
        char *aaaa = (char*)malloc(4 * sizeof(char) + 1);
        *aaaa = '\0';
        ...
        msg_id = esp_mqtt_client_publish(client, TOPIC_ATTRIBUTES, "{\"Conexao\":1}", 0, 1, 1);
    ...
    case MQTT_EVENT_SUBSCRIBED:
        ...
        print_user_property(event->property->user_property);
        esp_mqtt5_client_set_publish_property(client, &publish_property);
        msg_id = esp_mqtt_client_publish(client, TOPIC_ATTRIBUTES, "{\"TESTE\":4}", 0, 0, 0);
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);
        break;
    ...
    case MQTT_USER_EVENT:
        ...
        msg_id = esp_mqtt_client_publish(client, event->topic , event->data, 0, 1, 1);
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);
        break;
    default:
...
void mqtt5_app_start(esp_mqtt_client_handle_t *client)
{
    esp_mqtt5_connection_property_config_t connect_property = {
        ...
        .response_topic = TOPIC_TELEMETRY,
        .correlation_data = "123456",
        .correlation_data_len = 6,
    };
